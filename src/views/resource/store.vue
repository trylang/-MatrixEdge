<template>
  <div class="dashboard-editor-container">
    ...
    <el-row class="progress-content">
      ...
      <Table :header="storeHeader" :content="content"></Table>
    </el-row>
...
import { storeHeader, storeDialog } from './static.js';
export default {
  name: "DashboardAdmin",
  components: {
    Title,
  ...
  data() {
    return {
      ...
      storeHeader: storeHeader.concat({
          label: "操作",
          name: "operations",
          type: "buttons",
          style: {
      ...
      content: [],
      dialog: {
        models: storeDialog.models,
        dialogVisible: false,
        param: storeDialog.param,
        rules: storeDialog.rules,
        options: [{
          label: "确 定",
          name: "submit",
          type: "primary",
